...
namespace CommandAPI.Tests
{
    public class CommandsControllerTests : IDisposable
    {
        ...
        public void GetAllCommands_ReturnsOneItem_WhenDBHasOneResource()
        {
            //Arrange
            mockRepo.Setup(repo =>
                repo.GetAllCommands()).Returns(GetCommands(1)); var controller = new CommandsController(mockRepo.Object, mapper);
            //Act
            var result = controller.GetAllCommands();
            //Assert
        ...
        public void GetAllCommands_ReturnsCorrectType_WhenDBHasOneResource()
        {
            ...
            var controller = new CommandsController(mockRepo.Object, mapper);
            //Act
            var result = controller.GetAllCommands();//Assert
        ...
        [Fact]
        public void GetCommandByID_ReturnsCommandReadDto__WhenValidIDProvided()
        {
            //Arrange
            mockRepo.Setup(repo =>
                repo.GetCommandById(1)).Returns(new Command
